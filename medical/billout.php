...
<body style="background: #ECF0F5;padding:0;margin:0">
  ...
  <tr>
    <td class="center" colspan="4"><button class="btn btn-primary" onclick="window.print()">Print</button> <a href="index.php"><button class="btn btn-success">Cancel</button></a></td>
  </tr>
      </table>
    </div>
  </div>
